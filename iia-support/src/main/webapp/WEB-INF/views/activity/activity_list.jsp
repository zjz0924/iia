    ...
    <div class="row">
        <div class="col-lg-12">
            <ol class="breadcrumb">
                ...
                <li><i class="fa fa-bullhorn"></i>协会活动管理</li>
            </ol>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h2><i class="fa fa-bullhorn red"></i><span class="break"></span><strong>协会活动管理</strong></h2>
                ...
                <div class="panel-body">
                    <form id="queryForm" name="queryForm" action="${ctx}/activity/list" method="post">
