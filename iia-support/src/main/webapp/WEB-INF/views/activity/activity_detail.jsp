...
<head>
    ...
    <script type="text/javascript">
    	var filebrowserUploadUrl = "${ctx}/activity/uploadEditorFile?type=activity";
	</script>
    ...
    <script type="text/javascript">
        ...
        function save(){
			...
			$.ajax({
				url: "${ctx}/activity/save?time=" + new Date(),
				type: "post",
				data:{
					id: $("#id").val(),
					content: content,
        ...
        function cancel(){
        	window.location.href = "${ctx}/activity/list";
        }
    </script>
</head>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h2><i class="fa fa-bullhorn red"></i><span class="break"></span><strong>活动</strong></h2>
