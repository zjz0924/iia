...
<body>
    <div class="row">
        <div class="col-lg-12">
            <ol class="breadcrumb">
                <li><i class="fa fa-group"></i>会员组管理</li>
            </ol>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h2><i class="fa fa-group red"></i><span class="break"></span><strong>会员组管理</strong></h2>
                ...
                <div class="panel-body">
                    <form id="queryForm" name="queryForm" action="${ctx}/group/list" method="post">
                                ...
                                <tbody>
                                    <c:forEach items="${dataList}" var="vo" varStatus="vst">
                                        <tr>
                                            ...
                                            <td class="text-center text_size_14" style="width:40%;">${vo.name}</td>
