        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h2><i class="fa fa-comments red"></i><span class="break"></span><strong>服务内容</strong></h2>
                    <span style="float:right;padding-top:5px;">
                        <button type="button" class="btn btn-primary btn-xs" onclick="goTo('${ctx}/server/detail')">添加</button>
                    </span>
                </div>

                <div class="panel-body">
                    <form id="queryForm" name="queryForm" action="${ctx}/server/list" method="post">
                                ...
                                <tbody>
                                    <c:forEach items="${dataList}" var="vo" varStatus="vst">
                                        <tr>
                                            ...
                                            <td class="text-center text_size_14" style="width:40%;">${vo.title}</td>
                                            ...
                                            <td class="text-center text_size_14" style="width:18%;"><fmt:formatDate value='${vo.createTime}' type="date" pattern="yyyy-MM-dd hh:mm:ss" /></td>
                                            <td>
