    ...
    <div class="row">
        <div class="col-lg-12">
            <ol class="breadcrumb">
                ...
                <li><i class="fa fa-user"></i><a href="${ctx}/soundPic/list">声像图片管理</a></li>
                <li><i class="fa fa-user"></i>声像图片</li>
            </ol>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h2><i class="fa fa-user red"></i><span class="break"></span><strong>声像图片</strong></h2>
