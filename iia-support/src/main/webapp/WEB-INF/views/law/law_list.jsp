        ...
        <div class="col-lg-12">
            <ol class="breadcrumb">
                ...
                <c:choose>
                	...
                	<c:otherwise>
                		<li><i class="fa fa-lightbulb-o"></i>法律法规管理</li>
                	</c:otherwise>
                </c:choose>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h2>
                    	<c:choose>
		                	<c:when test="${type == 1}">
		                		<i class="fa fa-gavel red"></i><span class="break"></span><strong>政策管理</strong>
		                	</c:when>
		                	<c:otherwise>
		                		<i class="fa fa-lightbulb-o red"></i><span class="break"></span><strong>法律法规管理</strong>
		                	</c:otherwise>
		                </c:choose>
                    </h2>

                    <span style="float:right;padding-top:5px;">
                        <button type="button" class="btn btn-primary btn-xs" onclick="goTo('${ctx}/law/detail?type=${type}')">添加</button>
                    </span>
                </div>

                <div class="panel-body">
                    <form id="queryForm" name="queryForm" action="${ctx}/law/list?type=${type}" method="post">
