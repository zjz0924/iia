...
<head>
    ...
    <script type="text/javascript">
    	var filebrowserUploadUrl = "${ctx}/law/uploadEditorFile?type=law/${type}";
	</script>
    ...
    <script type="text/javascript">
        ...
        function save(){
			...
			$.ajax({
				url: "${ctx}/law/save?time=" + new Date(),
				type: "post",
				data:{
					id: $("#id").val(),
					content: content,
        ...
        function cancel(){
        	window.location.href = "${ctx}/law/list?type=${type}";
        }
    </script>
</head>
            ...
            <ol class="breadcrumb">
                ...
                <c:choose>
                	<c:when test="${type == 1}">
                		...
                		<li><i class="fa fa-gavel"></i>政策信息</li>
                	</c:when>
                	<c:otherwise>
                		<li><i class="fa fa-lightbulb-o"></i><a href="${ctx}/raw/list?type=2">法律法规管理</a></li>
                		<li><i class="fa fa-lightbulb-o"></i>法律法规信息</li>
                	</c:otherwise>
                </c:choose>
            </ol>
        </div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <c:choose>
	                	<c:when test="${type == 1}">
	                		<h2><i class="fa fa-gavel red"></i><span class="break"></span><strong>政策信息</strong></h2>
	                	</c:when>
	                	<c:otherwise>
	                		<h2><i class="fa fa-lightbulb-o red"></i><span class="break"></span><strong>法律法规信息</strong></h2>
	                	</c:otherwise>
	                </c:choose>
