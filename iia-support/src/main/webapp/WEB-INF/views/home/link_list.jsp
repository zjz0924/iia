...
<body>
    <div class="row">
        <div class="col-lg-12">
            <ol class="breadcrumb">
                <li><i class="fa fa-link"></i>友情链接管理</li>
            </ol>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form id="queryForm" name="queryForm" action="${ctx}/linkController/list" method="post">
                            ...
                            <table class="table table-bordered table-striped table-condensed table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text_size_14">logo</th>
                                        <th class="text_size_14">名称</th>
                                        <th class="text_size_14">链接</th>
                                    ...
                                    <c:forEach items="${dataList}" var="vo" varStatus="vst">
                                        <tr>
                                            ...
                                            <td class="text-center" style="width:8%;">
                                            	<img src="${resUrl}${vo.logo}" style="width:50px;height:50px;">
                                            </td>
                                            <td class="text-center text_size_14">${vo.name}</td>
                                            <td class="text-center text_size_14" style="width:25%;">${vo.url}</td>
                                            <td class="text-center text_size_14" style="width:8%;">${vo.sort}</td>
                                            <td class="text-center text_size_14" style="width:15%;">
