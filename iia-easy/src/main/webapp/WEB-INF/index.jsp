			...
			<div class="inner">
				...
				<div class="styles">
					<ul>
						...
						<li><a href="index.html@style=style1" rel="styles1"
							class="styleswitch red">&nbsp;</a></li>
						<li><a href="index.html@style=style2" rel="styles2"
							class="styleswitch blue">&nbsp;</a></li>
						<li><a href="index.html@style=style3" rel="styles3"
							class="styleswitch gray">&nbsp;</a></li>
						<li><a href="index.html@style=style4" rel="styles4"
							class="styleswitch orange">&nbsp;</a></li>
						<li><a href="index.html@style=style5" rel="styles5"
							class="styleswitch green">&nbsp;</a></li>
						<li><a href="index.html@style=style6" rel="styles6"
							class="styleswitch orange-red">&nbsp;</a></li>
					</ul>
				</div>
				<!-- Styleswitcher End -->
				<!-- Top Site Map Button Start -->
				<a href="javascript:animatedcollapse.toggle('jason')"
					class="togglebtn">Site Map</a>
						...
						<div class="widget mission-widget">
							...
							<ul>
								<li><a href="#" class="thumb"><img
										src="images/mission.jpg" alt="" /></a>
									<p>
										<a href="#" class="bold">Donec ut nibh tellus. Proin erat
											urna, luctuseg ementum at, facilisis sed nunc.</a>
									</p></li>
								<li><a href="#">Aenean commodo dolor at sapien luctus
										(05:30)</a></li>
						...
						<div class="widget recent-posts-thumbs">
							...
							<ul class="post-thumbs">
								<li>
									...
									<div class="desc">
										<a href="#" class="title">Lorem ipsum dolor sit amet,
											consect etur adipiscing elit.</a>
										<p>Donec ut nibh tellus. Proin erat urna, luct us eget
											elementum at, facilisis sed.</p>
								...
								<li>
									...
									<div class="desc">
										...
										<p>Luctus eget elementum at, facilisis sed unc Donec neque
											felis, fringilla.</p>
										<a href="#" class="readmoredark">Read more</a>
									</div>
								</li>
								<li>
									...
									<div class="desc">
										<a href="#" class="title">Facilisis sed nunconec neque
											felis.</a>
										<p>Donec ut nibh tellus. Proin erat urna, luct us eget
											elementum at, facilisis sed.</p>
										<a href="#" class="readmoredark">Read more</a>
						...
						<div class="widget contact-map">
							...
							<div class="mapframe">
								<iframe width="100%" height="150" frameborder="0" scrolling="no"
									...
									src="../../../../https@maps.google.com/maps@f=q&source=s_q&hl=en&geocode=&q=london&aq=&sll=37.0625,-95.677068&sspn=48.956293,107.138672&ie=UTF8&hq=&h08CBA19488"></iframe>
							</div>
							<p class="txt">Need to contact us or planning on making a
								visit? Just click the button below to send us a note or get
								directions to our location.</p>
							<p class="adres">
								1234 A 12th AB. Lorum Ipsum,<br /> NY, 123456<br /> P:
								123.456.7891<br />
							</p>
					...
					<div class="right">
								...
								<ul>
									...
									<li><a href="#">News / Events</a>
										<ul class="backcolr">
											...
											<li><a href="events-calendar.html">Events - Calander
													View</a></li>
										</ul></li>
										...
										<ul class="backcolr">
											...
											<li><a href="#">Events</a>
												<ul>
													<li><a href="events-both.html">Events - Combined</a></li>
													<li><a href="events-list.html">Events - List View</a></li>
													<li><a href="events-calendar.html">Events -
															Calander View</a></li>
												</ul></li>
											<li><a href="sermons.html">Sermons</a></li>
											<li><a href="#">Gallery</a>
												<ul>
													<li><a href="gallery-grid.html">Gallery - Grid</a></li>
													<li><a href="gallery-show.html">Gallery -
															SlideShow</a></li>
												</ul></li>
											<li><a href="contact-us.html">Contact Us</a></li>
										</ul></li>
						...
						<div class="search">
							...
							<div class="searchinputs backcolr">
								<ul>
									<li class="left"><input name="txtSearch"
										value="Enter Keyword"
		...
		<div id="banner">
			<div class="slider-wrapper theme-default">
				<div id="slider" class="nivoSlider">
					<a href="#"><img src="images/banner1.jpg" title="#banner1"
						alt="" /></a> <a href="#"><img src="images/banner2.jpg"
						title="#banner2" alt="" /></a> <a href="#"><img
						src="images/banner3.jpg" title="#banner3" alt="" /></a>
				</div>
					...
					<div class="followus">
						...
						<div class="follow">
							...
							<ul>
								...
								<li><a href="#"><img src="images/lastfm-icon.png"
										alt="" /></a></li>
								<li><a href="#"><img src="images/myspace-icon.png"
										alt="" /></a></li>
							</ul>
						</div>
						<!-- Follow Us End -->
